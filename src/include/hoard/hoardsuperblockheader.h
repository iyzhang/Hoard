...
namespace Hoard {
    ...
    class HoardSuperblockHeaderExtensible {
    public:
    ...
    public:
        ...
        HoardSuperblockHeaderExtensible (size_t sz, size_t bufferSize, char * start)
        ...
        virtual ~HoardSuperblockHeaderExtensible() {
            clear();
        }
        ...
        SuperblockType * getNext() const {
            return _next;
        }

        SuperblockType * getPrev() const {
            return _prev;
        }

        void setNext (SuperblockType * n) {
            _next = n;
        }

        void setPrev (SuperblockType * p) {
            _prev = p;
        }
    ...
    template <class LockType,
              int SuperblockSize,
              typename HeapType>
    class HoardSuperblockHeader : public HoardSuperblockHeaderExtensible<LockType,
                                                                         SuperblockSize,
                                                                         HeapType,
    ...
    public:
        ...
        HoardSuperblockHeader (size_t sz, size_t bufferSize)
            : HoardSuperblockHeaderExtensible<LockType,
                                              SuperblockSize,
                                              HeapType,
                                              HoardSuperblock<LockType,
                                                              SuperblockSize,
                                                              HeapType>>
            (sz, bufferSize, (char *) (this + 1))
        {
        ...
        typedef HoardSuperblock<LockType, SuperblockSize, HeapType> SuperblockType;
    private:

        typedef HoardSuperblockHeaderExtensible<LockType,
                                                SuperblockSize,
                                                HeapType,
                                                HoardSuperblock<LockType,
                                                                SuperblockSize,
